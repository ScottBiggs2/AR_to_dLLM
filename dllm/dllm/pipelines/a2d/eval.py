...
@dataclass
class MDLMEvalConfig(MDLMSamplerConfig):
...
class MDLMEvalHarness(LM):
    ...
    def __init__(self, config: MDLMEvalConfig | None = None, batch_size=None, **kwargs):
        ...
        self.max_length = int(max_length) if max_length is not None else 2048
...
class BD3LMEvalConfig(BD3LMSamplerConfig):
    ...
    is_check_greedy: bool = False
    device: str = "cuda"
    max_length: int = 2048 # Added to match implementation below
